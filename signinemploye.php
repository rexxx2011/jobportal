...
<body>
    ...
    <!-- END nav -->
	  ...
	  <section>
	  	<form enctype="multipart/form-data" method="post" action="createemploye.php">
	  			...
	  			<div class="row">
	  				<div class="col-md-12 col-lg-8 mb-4">
			              ...
			              <div class="row form-group">
			                  ...
			                  <select name="score1type" class="col-md-12 mb-3 mb-md-0 form-control">
			                    <option>-----------</option>
			                    <option>CGPA</option>
			                ...
			                <div class="col-md-6 mb-3 mb-md-0">
			                	<input type="text" name="score1" class="form-control" style="width: 50%;">
			              ...
			              <div class="row form-group">
			                ...
			                <div class="col-md-6 mb-3 mb-md-0">
			                  <select name="score2type" class="col-md-12 mb-3 mb-md-0 form-control">
			                    <option>-----------</option>
			                    <option>CGPA</option>
			                    <option>Percentage</option>
			                  </select>                  
			                ...
			                <div class="col-md-6 mb-3 mb-md-0">
			                	<input type="text" name="score2" class="form-control" style="width: 50%;">
			              ...
			              <div class="row form-group">
			                ...
			                <div class="col-md-6 mb-3 mb-md-0">
			                  <select name="score3type" class="col-md-12 mb-3 mb-md-0 form-control">
			                    <option>-----------</option>
			                    <option>CGPA</option>
			                    <option>Percentage</option>
			                  </select>                  
			                ...
			                <div class="col-md-6 mb-3 mb-md-0">
			                	<input type="text" name="score3" class="form-control" style="width: 50%;">
